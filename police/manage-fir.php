...
{               ?>
										<tr>
											...
											<td>
												<a href="view-fir-details-detail.php?editid=<?php echo htmlentities ($row->ID);?>"><i class="fa fa-pencil"></i></a>
												<a href="manage-fir.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Do you really want to Delete ?');" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
											</td>
										</tr>
