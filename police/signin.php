						...
						<form method="post">
							<div class="form-group mb-lg">
								...
								<div class="input-group input-group-icon">
									 <input type="text" class="form-control input-lg" placeholder="Enter Your ID" required="true" name="pid">
							...
							<div class="form-group mb-lg">
								...
								<div class="input-group input-group-icon">
									<input type="password" class="form-control input-lg" name="password" required="true" value="" placeholder="Enter Password"/>
									<span class="input-group-addon">
										<span class="icon icon-lg">
