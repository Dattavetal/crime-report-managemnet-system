						...
						<form method="post">
							<div class="form-group mb-lg">
								...
								<div class="input-group input-group-icon">
									 <input type="email" class="form-control input-lg" placeholder="Email" required="true" name="email">
							...
							<div class="form-group mb-lg">
								...
								<div class="input-group input-group-icon">
									<input type="password" class="form-control input-lg" name="password" required="true" value=""/ placeholder="Password">
									<span class="input-group-addon">
										<span class="icon icon-lg">
