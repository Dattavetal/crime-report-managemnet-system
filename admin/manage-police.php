...
{               ?>
										<tr>
											...
											<td>
												<a href="edit-police-detail.php?editid=<?php echo htmlentities ($row->ID);?>"><i class="fa fa-pencil"></i></a>
												<a href="manage-police.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Do you really want to Delete ?');" ><i class="fa fa-trash-o"></i></a>
											</td>
										</tr>
